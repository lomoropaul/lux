        ...
        <div className="flex flex-col">
          ...
          {product.size && (
            <p className="text-sm text-stone-600 mb-4">
              Size: <span className="text-stone-900">{product.size}</span>
            </p>
          )}
          ...
          {product.notes && (
            <div className="mb-8 p-4 bg-stone-50 border border-stone-200">
              <p className="text-xs tracking-[0.15em] uppercase text-stone-500 mb-2">
                Fragrance Notes
              </p>
              <p className="text-sm text-stone-700">{product.notes}</p>
            </div>
          )}
